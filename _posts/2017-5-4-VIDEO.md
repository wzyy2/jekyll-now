...
虽然ffmpeg从3.5以后就有mpp支持， 但是除非你很了解这些，不然不推荐使用，请不要觉得xxx app使用的ffmpeg，我替换一个可以调的mpp的ffmpeg就可以工作了，这里涉及到一个format和zero-copy的问题。
...
另外你要很好的理解这块内容，最好接触下下面的概念，不然我也不想解释：
`v4l2, dmabuf, gstreamer,drm, opengles`
