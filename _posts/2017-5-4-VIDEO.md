...
MIPI Camera:
```
gst-launch-1.0 rkcamsrc device=/dev/video0 io-mode=4 3A-mode=2A ! videoconvert ! video/x-raw,format=NV12,width=640,height=480  ! kmssink
```
...
我的建议是，用[yocto](http://opensource.rock-chips.com/wiki_Yocto)，不然就去google。
