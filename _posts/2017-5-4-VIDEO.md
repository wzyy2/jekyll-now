...
这里主要记录一些月经问题, 主要帮助通过gstreamer来在rockchip平台上做multimedia的开发, 如果你需要直接用使用底层的api, 比如通过mpp完成decode/encode, 通过v4l2操作rga做color convert, 可能需要先理解下DRM, V4L2, DMABUF, OpenGLES等概念.
